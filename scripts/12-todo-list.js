...
function renderTodoList() {
  ...
  .forEach((deleteButton, index) => {
    deleteButton.addEventListener('click', () => {
      // console.log(index);//it will print index eventhough its deleted after each loop because of closure properties that is a function always has access to its scope it never forgets the scope
